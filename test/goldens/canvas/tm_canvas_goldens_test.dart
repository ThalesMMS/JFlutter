  ...
  group('TMCanvasGraphView golden tests', () {
    testGoldens(
      ...
      (tester) async {
        ...
        final controller = GraphViewTmCanvasController(
    ...
    testGoldens(
      ...
      (tester) async {
        ...
        await screenMatchesGolden(
          tester,
          'tm_canvas_initial_accepting_state',
        );
    ...
    testGoldens(
      'renders multiple states with TM transitions',
      (tester) async {
        final provider = _TestTMEditorProvider();
        final controller = GraphViewTmCanvasController(
          editorNotifier: provider,
    ...
    testGoldens(
      'renders complex TM with multiple transitions',
      (tester) async {
        final provider = _TestTMEditorProvider();
        final controller = GraphViewTmCanvasController(
          editorNotifier: provider,
