  ...
  group('REGEX Validation Tests', () {
    group('Regex to NFA Conversion Tests', () {
      ...
      test('Complex regex should convert to NFA', () async {
        ...
        for (final regex in testCases) {
          ...
          if (result.isSuccess) {
            final nfa = result.data!;
            expect(nfa.states.length, greaterThan(2),
      ...
      test('Regex with parentheses should convert correctly', () async {
        ...
        for (final regex in testCases) {
          ...
          expect(result.isSuccess, true, 
            reason: 'Regex with parentheses "$regex" should convert successfully');
        }
      });
          ...
          if (result1.isSuccess && result2.isSuccess) {
            ...
            for (final testString in testStrings) {
              ...
              if (sim1.isSuccess && sim2.isSuccess) {
                expect(sim1.data!.accepted, sim2.data!.accepted,
        ...
        for (final pair in nonEquivalentPairs) {
          ...
          if (result1.isSuccess && result2.isSuccess) {
            ...
            expect(foundDifference, true,
              reason: 'Non-equivalent regexes should produce different behavior');
          }
        }
      });
    });
      ...
      test('Concatenation operations should work correctly', () async {
        ...
        for (final regex in testCases) {
          ...
          if (result.isSuccess) {
            ...
            expect(nfa.states.length, greaterThan(1),
        ...
        for (final regex in testCases) {
          ...
          if (result.isSuccess) {
            ...
            if (emptySim.isSuccess) {
              expect(emptySim.data!.accepted, true,
    ...
    group('Performance Tests', () {
      test('Complex regex should convert efficiently', () async {
        final complexRegex = '(a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z)*';
        ...
        if (result.isSuccess) {
          final nfa = result.data!;
          expect(nfa.states.length, greaterThan(10),
