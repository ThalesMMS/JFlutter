  ...
  group('PDACanvasGraphView golden tests', () {
    testGoldens(
      ...
      (tester) async {
        ...
        final controller = GraphViewPdaCanvasController(
    ...
    testGoldens(
      'renders single accepting state',
      (tester) async {
        final provider = _TestPDAEditorProvider();
        final controller = GraphViewPdaCanvasController(
          editorNotifier: provider,
    ...
    testGoldens(
      'renders initial and accepting state',
      (tester) async {
        final provider = _TestPDAEditorProvider();
        final controller = GraphViewPdaCanvasController(
          editorNotifier: provider,
        ...
        await screenMatchesGolden(
          tester,
          'pda_canvas_initial_accepting_state',
        );
    ...
    testGoldens(
      'renders multiple states with PDA transitions',
      (tester) async {
        final provider = _TestPDAEditorProvider();
        final controller = GraphViewPdaCanvasController(
          editorNotifier: provider,
    ...
    testGoldens(
      'renders balanced parentheses PDA',
      (tester) async {
        final provider = _TestPDAEditorProvider();
        final controller = GraphViewPdaCanvasController(
          editorNotifier: provider,
    ...
    testGoldens(
      'renders complex PDA with multiple transitions',
      (tester) async {
        final provider = _TestPDAEditorProvider();
        final controller = GraphViewPdaCanvasController(
          editorNotifier: provider,
