...
void main() {
  ...
  group('PdaTransitionEditor golden tests', () {
    ...
    testGoldens(
      'renders with lambda input enabled',
      (tester) async {
        await tester.pumpWidgetBuilder(
          PdaTransitionEditor(
            initialRead: '',
    ...
    testGoldens(
      'renders with lambda pop enabled',
      (tester) async {
        await tester.pumpWidgetBuilder(
          PdaTransitionEditor(
            initialRead: 'a',
    ...
    testGoldens(
      'renders with lambda push enabled',
      (tester) async {
        await tester.pumpWidgetBuilder(
          PdaTransitionEditor(
            initialRead: 'a',
    ...
    testGoldens(
      'renders with all lambdas enabled',
      (tester) async {
        await tester.pumpWidgetBuilder(
          PdaTransitionEditor(
            initialRead: '',
    ...
    testGoldens(
      'renders with complex push sequence',
      (tester) async {
        await tester.pumpWidgetBuilder(
          PdaTransitionEditor(
            initialRead: 'a',
  ...
  group('TmTransitionOperationsEditor golden tests', () {
    testGoldens(
      'renders with initial values and right direction',
      (tester) async {
        await tester.pumpWidgetBuilder(
    ...
    testGoldens(
      'renders with multi-character symbols',
      (tester) async {
        await tester.pumpWidgetBuilder(
          TmTransitionOperationsEditor(
            initialRead: 'abc',
  ...
  group('TransitionLabelEditorForm golden tests', () {
    ...
    testGoldens(
      'renders in touch-optimized mode',
      (tester) async {
        await tester.pumpWidgetBuilder(
          TransitionLabelEditorForm(
            initialValue: 'a,b',
