...
void main() {
  group('Error Banner Widget Tests', () {
    ...
    testWidgets('ErrorBanner shows retry button when onRetry is provided', (tester) async {
    ...
    testWidgets('ErrorBanner shows dismiss button when onDismiss is provided', (tester) async {
    ...
    testWidgets('ErrorBanner handles both retry and dismiss actions', (tester) async {
      bool retryCalled = false;
      bool dismissCalled = false;
    ...
    testWidgets('ErrorBanner displays different error types correctly', (tester) async {
      final errorTypes = [
        'Invalid file format',
        'File not found',
        'Network error',
  ...
  group('Import Error Dialog Tests', () {
    testWidgets('ImportErrorDialog displays error details correctly', (tester) async {
    ...
    testWidgets('ImportErrorDialog handles different error scenarios', (tester) async {
  ...
  group('Retry Button Tests', () {
    testWidgets('RetryButton displays correctly with default text', (tester) async {
      bool retryCalled = false;
  ...
  group('Error State Management Tests', () {
    testWidgets('Error state is properly managed in widget tree', (tester) async {
      bool hasError = true;
    ...
    testWidgets('Multiple error states are handled correctly', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Column(
              children: errors.map((error) => ErrorBanner(
                message: error,
                onRetry: () {},
                onDismiss: () {},
              )).toList(),
  ...
  group('User Interaction Flow Tests', () {
    testWidgets('Complete error handling flow from import to retry', (tester) async {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          ...
                          currentError = 'Failed to import file: Invalid format';
                        });
                      },
      ...
      expect(find.byType(ErrorBanner), findsOneWidget);
      expect(find.text('Failed to import file: Invalid format'), findsOneWidget);
