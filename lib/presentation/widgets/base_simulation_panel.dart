...
/// Mixin that provides common simulation panel functionality
///
/// This mixin can be used with both State and ConsumerState to share
/// common simulation panel logic
mixin SimulationPanelMixin<T extends StatefulWidget> on State<T> {
  /// Controller for the input string text field
  final TextEditingController inputController = TextEditingController();
