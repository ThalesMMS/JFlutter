...
This document describes JFlutter's embedded examples library and educational features that support formal language theory learning. The examples system provides pre-built automata, grammars, and Turing machines with educational metadata for classification and discovery. For file import/export operations, see [Import and Export System](#9).
...
* [Examples and Learning Features](#10-examples-and-learning-features)
* [Examples Library Architecture](#10-examples-library-architecture)
* [Component Overview](#10-component-overview)
* [Example Categories and Metadata](#10-example-categories-and-metadata)
* [Category System](#10-category-system)
* [Difficulty Levels](#10-difficulty-levels)
* [Complexity Levels](#10-complexity-levels)
* [Embedded Example Assets](#10-embedded-example-assets)
* [Asset Manifest](#10-asset-manifest)
* [Example Naming Convention](#10-example-naming-convention)
* [ExamplesAssetDataSource](#10-examplesassetdatasource)
* [Core Methods](#10-core-methods)
* [Category Discovery](#10-category-discovery)
* [Search Functionality](#10-search-functionality)
* [ExamplesService](#10-examplesservice)
* [Service Architecture](#10-service-architecture)
* [Loading Examples](#10-loading-examples)
* [ExampleEntity Data Structure](#10-exampleentity-data-structure)
* [Structure Definition](#10-structure-definition)
* [Example Metadata Usage](#10-example-metadata-usage)
* [Integration with Application State](#10-integration-with-application-state)
* [Loading Flow](#10-loading-flow)
* [Integration Test Example](#10-integration-test-example)
* [Serialization and Round-Trip Testing](#10-serialization-and-round-trip-testing)
* [Test Coverage Matrix](#10-test-coverage-matrix)
* [Round-Trip Testing](#10-round-trip-testing)
* [SVG Export for Examples](#10-svg-export-for-examples)
* [SVG Export Methods](#10-svg-export-methods)
* [SVG Export Options](#10-svg-export-options)
* [SVG Structure](#10-svg-structure)
* [Pumping Lemma Game](#10-pumping-lemma-game)
* [Expected Features (Based on Architecture)](#10-expected-features-based-on-architecture)
* [Example Usage Patterns](#10-example-usage-patterns)
* [Pattern 1: Direct Asset Loading](#10-pattern-1-direct-asset-loading)
* [Pattern 2: Service-Based Loading](#10-pattern-2-service-based-loading)
* [Pattern 3: Search and Discovery](#10-pattern-3-search-and-discovery)
* [Testing Infrastructure](#10-testing-infrastructure)
* [Test Categories](#10-test-categories)
* [Test Execution Flow](#10-test-execution-flow)
